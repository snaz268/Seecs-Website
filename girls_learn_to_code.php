...
$result1 = mysqli_query($mysqli, "SELECT e_id,e_date,e_name,e_location,e_time,e_desc,e_img FROM event where e_society = 'acm' and e_name='Girls Learn To Code';");

$event1 = mysqli_fetch_array($result1);
?>
<html>
<head>
<title>Girls Learn To Code</title>
...
<body>
 ...
 <div class = "acm_head">
    ...
    <a style="display:none;" id=update href="acm_oneEvent_edit.php?e_id= <?php echo $event1['e_id'] ?>"><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
