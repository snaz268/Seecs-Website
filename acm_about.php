...
$_SESSION['currentpage'] = $_SERVER['REQUEST_URI'];
 $result = mysqli_query($mysqli, "SELECT s_aim,s_history FROM society  where s_name = 'acm';");
 $result2 = mysqli_query($mysqli, "SELECT s_cover_img FROM society  where s_name = 'acm';");
...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
    <button class="dropbtn activemenu">Societies
...
<div class="clear"> </div>
 <div class = "acm_head">
    ...
    <a style="display:none" id=update href=acm_about_edit.php><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
...
<div class="clear"> </div></div></br></br></br></br>
...
<?php
 echo "<div class=\"rimg\">";
 echo "<img alt=\"Avatar\" width=\"200px\" height=\"200px\" src=".$name1['m_img']." >";
 echo "<br/>"."<br/>"; 
 echo $name1['u_name'];
 echo "<br/>"."<br/>"."</div>";

 echo "<div class=\"rimg\">";
 echo "<img alt=\"Avatar\" width=\"200px\" height=\"200px\"  src=".$name2['m_img']." >";
 echo "<br/>"."<br/>"; 
 echo $name2['u_name'];
 echo "<br/>"."<br/>"."</div>";

 echo "<div class=\"rimg\">";
 echo "<img alt=\"Avatar\" width=\"200px\" height=\"200px\"  src=".$name3['m_img']." >";
 echo "<br/>"."<br/>"; 
 echo $name3['u_name'];
 echo "<br/>"."<br/>"."</div>";

 echo "<div class=\"rimg\">";
 echo "<img alt=\"Avatar\" width=\"200px\" height=\"200px\"  src=".$name4['m_img']." >";
 echo "<br/>"."<br/>"; 
 echo $name4['u_name'];
 echo "<br/>"."<br/>"."</div>";

 echo "<div class=\"rimg\">";
 echo "<img alt=\"Avatar\" width=\"200px\" height=\"200px\"  src=".$name5['m_img']." >";
 echo "<br/>"."<br/>"; 
 echo $name5['u_name'];
 echo "<br/>"."<br/>"."</div>";
 ?>
