...
$result1 = mysqli_query($mysqli, "SELECT e_id,e_date,e_name,e_location,e_time,e_desc,e_img FROM event where e_society = 'acm' and e_name='Mannequin Challenge';");
$event1 = mysqli_fetch_array($result1);
?>
<html>
<head>
<title>Mannequin Challenge</title>
