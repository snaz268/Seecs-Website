...
<?php
	...
	$GLOBALS['theme'] = $row[2];
	$e_id = $_GET['e_id'];
	$res2= mysqli_query($mysqli, "SELECT * FROM event where e_id = '$e_id'");
	$obj2=mysqli_fetch_object($res2); 
	$row2 = array('1'=>$obj2->e_img,'2'=>$obj2->e_name,'3'=>$obj2->e_date, '4'=>$obj2->e_location, '5'=>$obj2->e_desc);
	$mysqli->close();
?>
<html>
	<head><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<title>SeecsNews | Society Event</title>
<meta charset="UTF-8">
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:20px;padding-right: 0;"> 
	<div class = "right_col col-b-1 col-4 col-t-12 col-m-12">
...
<div class="w3-container">
	  ...
	  <div class="pic_div_align">
	  	<div class = "outer_pic_div_right col-b-2 col-8 col-t-7 col-m-12" style="background-image: url('<?php echo $row2[1];?>');">
		<div class ="inner_pic_div" style="background-color: transparent;">
			<form method="post" action="update_event_img.php" enctype="multipart/form-data">
  ...
  <!-- The Grid -->
    ...
    <div class = "other_col_right col-b-2 col-8 col-t-12 col-m-12">
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
            	...
            	<form action = "update_oneEvent.php" method = "post" enctype="multipart/form-data">
            		<input type="hidden" name = "e_society" value= "<?php echo $row[1] ?>">
            		<input type="hidden" name = "e_id" value= "">
            		<h3><?php echo $row2[2]?></h3>
            		<hr class="up">
            		<div class="home_div">
						...
						<div class="home_div_right">
							<input type="text" name = "e_name" value="<?php echo $row2[2]?>">
						</div>
					</div>
					<div class="clear"></div>
					<div class="home_div">
						...
						<div class="home_div_right">
							<input type="text" name = "e_date" value="<?php echo $row2[3]?>">
						</div>
					</div>
					<div class="clear"></div>
					<div class="home_div">
						...
						<div class="home_div_right">
							<input type="text" name = "e_location" value="<?php echo $row2[4]?>">
						</div>
					</div>
					<div class="clear"></div>
					<div class="home_div">
						...
						<div class="home_div_right">
							<input type="text" name = "e_desc" value="<?php echo $row2[5]?>">
						</div>
					</div>
					<div class="clear"></div>
					<div style="right">
					  <input type="submit" class="t_btn" name = "update" value = "Save">
					</div>	
				</form>
        </div>
      </div>
