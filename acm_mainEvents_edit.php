...
<html>
	<head>
		...
		<title>SeecsNews | <?php echo $row[1] ?> Events</title>
		<meta charset="UTF-8">
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:20px;padding-right: 0;"> 
  ...
  <!-- The Grid -->
    ...
    <div class = "other_col col-b-2 col-8 col-t-7 col-m-12">
        ...
        <div class="w3-col m12">
          <div class="card w3-round w3-white">
            <div class="w3-container w3-padding">
				 <h3>Upcoming Events</h3><hr class="up">
		  <?php
		  	include("connection.php");
		  	$date = date("Y-m-d");
		  	$res2= mysqli_query($mysqli, "SELECT * FROM event
										WHERE e_date >='$date' AND e_society = '$s_name' 
			...
			while($res = mysqli_fetch_array($res2)) { 
					echo "<div class=\"cont_left\">";
		  			echo "<div class = \"e_date col-3 col-t-12 col-m-12\">".$res['e_date']."<br>".$res['e_time']."</div>";
					echo "<div class=\"e_name col-3 col-t-12 col-m-12\">".$res['e_name']."</div>";
					echo "<div class=\"e_place col-3 col-t-12 col-m-12\">".$res['e_location']."</div>";
					echo "<div class= \"col-3 col-t-12 col-m-12\" style=\"float:right\">";					

					echo "<form method=\"post\" action=\"delete_event.php\">";
					echo "<input type=\"hidden\" name=\"e_id\" value=".$res['e_id']." >";
					echo "<div class = \"right\">";
					echo " <input type=\"submit\" class=\"t_btn\" name = \"delete\" value = \"Delete\">";
					echo "</div>";
					echo "</form>";	
					
					echo "<div class = \"right\" style = \"padding-right:5%\">";
					echo "<input type=\"button\" class=\"t_btn\" value=\"&nbsp;&nbsp;Edit&nbsp;&nbsp;\" onclick=\"window.location.href='a_oneEvent.php?e_id=". $res['e_id']."'\">";
					echo "</div>";
		...
		<div class="w3-container card w3-white w3-round w3-margin w3-padding">
		  <h3>Previous Events</h3><hr class="up">
		  <?php
		  	include("connection.php");
		  	$date = date("Y-m-d");
		  	$res3= mysqli_query($mysqli, "SELECT * FROM event
										Where e_date <'$date' AND e_society = '$s_name' 
										ORDER BY e_date DESC;");
		  	if (!$res3) {
			    printf("Error: %s\n", mysqli_error($mysqli));
			...
			while($res4 = mysqli_fetch_array($res3)){ 
					echo "<div class=\"cont_left\">";
		  			echo "<div class = \"e_date col-3 col-t-12 col-m-12\">".$res4['e_date']."<br>".$res4['e_time']."</div>";
					echo "<div class=\"e_name col-3 col-t-12 col-m-12\">".$res4['e_name']."</div>";
					echo "<div class=\"e_place col-3 col-t-12 col-m-12\">".$res4['e_location']."</div>";
					echo "<div class= \"col-3 col-t-12 col-m-12\" style=\"float:right\">";					

					echo "<form method=\"post\" action=\"delete_event.php\">";
					echo "<input type=\"hidden\" name=\"e_id\" value=".$res4['e_id']." >";
					echo "<div class = \"right\">";
					echo " <input type=\"submit\" class=\"t_btn\" name = \"delete\" value = \"Delete\">";
					echo "</div>";
					echo "</form>";	
					...
					echo "<div class = \"right\" style = \"padding-right:5%\">";
					echo "<input type=\"button\" class=\"t_btn\" value=\"&nbsp;&nbsp;Edit&nbsp;&nbsp;\" onclick=\"window.location.href='a_oneEvent.php?e_id=". $res4['e_id']."'\">";
					echo "</div>";
...
<script>
	...
	$("#green").click(function(){//change theme to green
		$(".t_btn").css("background-color","#118039");
		$(".btn_style").css("background-color","#118039");
		$(".edit_btn").css("background-color","#118039");
		$('.side_bar_button')
	...
	$("#yellow").click(function(){//chneg theme to yellow
		$(".t_btn").css("background-color","#FFC600");
		$(".btn_style").css("background-color","#FFC600");
		$(".edit_btn").css("background-color","#FFC600");
		$('.side_bar_button')
	...
	$("#red").click(function(){//change theme to red
		$(".t_btn").css("background-color","#C30202");
		$(".btn_style").css("background-color","#C30202");
		$(".edit_btn").css("background-color","#C30202");
		$('.side_bar_button')
	...
	$("#blue").click(function(){//change theme to blue
		$(".t_btn").css("background-color","#010072");
		$(".btn_style").css("background-color","#010072");
		$(".edit_btn").css("background-color","#010072");
		$('.side_bar_button')
