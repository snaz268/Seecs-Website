...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="home.php">SGA</a>      <a href="#">TABA</a>
      <a href="#">YES</a>
      <a href="#">IEEE</a>
      <a href="#">Gaming</a>
    </div>
  ...
  <div class = "head">
    ...
    <a style="display:none;" id=update href=sga_vid_edit.php><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
...
<div  class="col-12 col-m-9  w3-teal ">
  ...
  <?php
  $res = mysqli_query($mysqli,"SELECT v_name FROM video where v_society = 'sga';");
