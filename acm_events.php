...
$_SESSION['currentpage'] = $_SERVER['REQUEST_URI'];
 ...
 $result = mysqli_query($mysqli, "SELECT e_id,e_date,e_name,e_location,e_time FROM event where e_society = 'acm'  order by e_date desc;");
$result1 = mysqli_query($mysqli, "SELECT e_link,e_id,e_date,e_name,e_location,e_time FROM event where e_society = 'acm' and e_date>now() order by e_date desc ;");
...
<div class="topnav" id="myTopnav">
  ...
  <div class = "acm_head">
    ...
    <a style="display:none;" id=update href=acm_mainEvents_edit.php><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
