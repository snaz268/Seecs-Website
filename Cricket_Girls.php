...
$result1 = mysqli_query($mysqli, "SELECT e_id,e_date,e_name,e_location,e_time,e_desc,e_img FROM event where e_society = 'sga' and e_name='Cricket Girls';");

$event1 = mysqli_fetch_array($result1);
?>
<html>
<head>
<title>Cricet Girls</title>
...
<body>
  ...
  <div class = "head">
    ...
    <a style="display:none;" id=update href="sga_oneEvent_edit.php?e_id= <?php echo $event1['e_id'] ?>"><buttonclass="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
