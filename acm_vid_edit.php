...
$checkbox = $_POST['check'];
	for($i=0;$i<count($checkbox);$i++){
		$del_id = $checkbox[$i];
		mysqli_query($mysqli,"DELETE FROM video WHERE v_id='".$del_id."'");
		$message = "Data deleted successfully !";
	}
}
	$v_result = mysqli_query($mysqli,"SELECT * FROM video WHERE v_society = '$s_name' ");
	$mysqli->close();
?>

<html>
	<head><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<title>SeecsNews | <?php echo $row[1] ?> Videos</title>
<meta charset="UTF-8">
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
             <div class="w3-container w3-padding">
			   <div style="float: left"><h3>&nbsp;Videos</h3></div>
			   <br><br><br>
			   <div style="float:left; position: relative;">
				  	<form method="post" action="add_video.php" enctype="multipart/form-data">
				  		<input type="hidden" name="v_society" value="<?php echo $row[1] ?>">
...
<div class="w3-container w3-padding">
		...
		?>
		<div class="video_container col-b_vid-1 col-photos-5 col-m_photos-12">
			<input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row['v_id']; ?>">
			<div class = "vid_style">
				<video class = "videos" controls >
					<source src="<?php echo $row['v_name'];?>" type="video/mp4">
