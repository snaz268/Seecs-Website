...
$result = mysqli_query($mysqli, "SELECT p_name FROM photo where e_society = 'sga';"); // using mysqli_query instead
?>
<html>
<head>
<title>Photos</title>
...
<div class="topnav" id="myTopnav">
  ...
  <div class = "head">
    ...
    <a style="display:none;" id=update href=sga_pic_edit.php><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
...
<?php
  $res = mysqli_query($mysqli,"SELECT p_name FROM photo  where p_society = 'sga';");
while($row = mysqli_fetch_array($res)){

  echo "<div class=\"w3-card w3-third\">";
  echo "<img style='width:300px; height:300px' src=". $row['p_name'].">";
  echo "<br />";
  echo"</div>";
}
