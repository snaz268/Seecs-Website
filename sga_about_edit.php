...
<title>SeecsNews | <?php echo $row[1] ?> About Us</title>
<meta charset="UTF-8">
...
<!-- FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM FORM  -->
				...
				<?php echo "<input type=\"hidden\" name=\"s_theme\" value = ".$GLOBALS['theme'].">"?>
				<input type="hidden" name="s_name" value="<?php echo $s_name ?>">
				<div class = "a_little_padding"></div>
				<h4 class="inline">Society Name: &nbsp;
					</h4>
				<input type="text" name = "society_name" value="<?php echo $row[1]?>">
				<hr>
				
				<div>
				<h4>Your Society's Aim:</h4>
			<input type="text" class = "textBox" name = "s_aim" value="<?php echo $row[3]?>">
			<h4>Your Society's History:</h4>
			<input type="text" class = "textBox" name="s_history" value="<?php echo $row[4]?>">
				</div>
				 <div class="btn_style right"><a href=""><input type="submit" class="t_btn" name ="save" value="Save"></a>  </div>
