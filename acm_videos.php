...
<div class = "acm_head">
    ...
    <a style="display:none;" id=update href=acm_vid_edit.php><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
</br>
    <div class="clear"> </div>
...
<div  class="col-12 col-m-9  w3-teal ">
  ...
  <?php
  $res = mysqli_query($mysqli,"SELECT v_name FROM video where v_society = 'acm';");
while($row = mysqli_fetch_array($res)){


  echo "<div class=\"w3-third\">";
  echo "<div class=\"w3-card\">";
  echo "<video height=\"300px\" width=\"300px\"  controls src=". $row['v_name'].">";
  echo "</video>";
  echo"</div>";  
  echo"</div>";
