...
include_once(".\sessions.php");
 ...
 $result = mysqli_query($mysqli, "SELECT s_cover_img FROM society  where s_name = 'sga';");
 $res=mysqli_fetch_array($result );  
  $eve = mysqli_query($mysqli, "SELECT e_link, e_img ,e_name FROM event where e_society = 'sga';");
...
<div class="clear"></div>
    ...
    <a  style="display:none;" id=update href=sga_home_edit.php><button class="loginbtn">Update</button></a>
    <div class=clear></div>
  </div>
    <div class="clear"></div>
