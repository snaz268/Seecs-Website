...
$result1 = mysqli_query($mysqli, "SELECT e_id,e_date,e_name,e_location,e_time,e_desc,e_img FROM event where e_society = 'sga' and e_name='Drama Fest';");

$event1 = mysqli_fetch_array($result1);
?>
<html>
<head>
<title>Drama Fest</title>
