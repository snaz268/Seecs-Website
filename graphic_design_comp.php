...
$result1 = mysqli_query($mysqli, "SELECT e_id,e_date,e_name,e_location,e_time,e_desc,e_img FROM event where e_society = 'acm' and e_name='Graphic Design Competition';");
...
<div class="col-12 col-m-9">
  <div class="w3-container w3-card w3-white w3-round w3-margin">
      <h3>Graphic Design Competition</h3>
